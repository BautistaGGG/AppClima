...
//https://api.openweathermap.org/data/2.5/onecall?lat=48.8534&lon=2.3488&exclude=current,minutely,hourly,alerts&appid=9cdc246f2409f7ddf8c8ed3bc15cfdcd&units=metric
...
function formatCurrentWeather(data) {
    const { 
     ...
     return {lat,lon, temp,temp_min,temp_max,feels_like,humidity,name,
  ...
  console.log(data)
    ...
    daily = daily.slice(1, 6).map((d) => {
      return {
        ...
        temp: d.temp.day,
        descriptionWeather: d.weather[0].description,
